...
export default function Contacto() {
  ...
  return (
    <section id="contacte" className="py-16 px-4 sm:px-6 lg:px-8">
      <motion.div
        ref={ref}
      ...
      >
        ...
        <p className="text-base sm:text-lg text-gray-700 mb-4">
          Ens pots trobar a l&apos;adreça següent o contactar amb nosaltres per telèfon o correu electrònic.
        </p>

        <div className="text-base sm:text-md text-bressolsAzul font-bold mb-6 leading-relaxed">
          Av. del Mar, 29<br />
          12200 El Monte Blanco, Castelló<br />
          Tel: 964 123 456<br />
